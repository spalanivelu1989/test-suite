...
test("buildGeneratorPack passes decisions and full reuse source through (copy-forward payload, unbounded)", () => {
...
test("buildGeneratorPack keeps every reuse spec's source, even for a large suite", () => {
