...
// of a before/after diff hunk that labels HOW the Healer fixed a failure. Pure and
 ...
 *
 * `outcomeFixme` short-circuits to `fixme` — when the Healer quarantined the test
