  ...
  return (
    <Box w="100%" px={0} py={2} color={colors.text}>
      ...
      <Flex direction={{ base: "column", xl: "row" }} gap={8} align="stretch">
        {/* LEFT PANEL: Analyzer Console (28%) */}
        <Box
          w={{ base: "100%", xl: "28%" }}
          bg={colors.cardBg}
        ...
        >
          <Flex align="center" gap={2} mb={1}>
            <Sliders size={16} color={c.sapphire} />
            <Text
              fontSize="sm"
              fontWeight="800"
              textTransform="uppercase"
          ...
          <Box position="relative">
            <Textarea
              ...
              _focus={{
                ...
                boxShadow: `0 0 0 2px ${catppuccinAlpha(c.sapphire, 0.4)}`,
              }}
              pb="34px"
              onKeyDown={(e) => {
          ...
          <VStack gap={3} align="stretch">
            <Box>
              ...
              {/* Live status — ties the URL straight to the decision branch. */}
              <Flex align="center" gap={1.5} mt={1.5} fontSize="10px">
                {!appId.trim() ? (
                  ...
                  <Text color={c.green}>
                    <Check
                      ...
                      style={{ display: "inline", marginRight: 4 }}
                    />
                    Known app · {knownApp.specCount} specs — in-app reuse
                    available.
                  </Text>
                ) : (
                  <Text color={c.mauve}>
                    <Sparkles
                      ...
                      style={{ display: "inline", marginRight: 4 }}
                    />
                    New app (no prior specs) — goes straight to cross-app.
                  </Text>
                )}
              </Flex>
            </Box>
            ...
            <Flex gap={3} align="flex-end">
              <Box flex="1">
                <Text fontSize="xs" fontWeight="700" color={colors.text} mb={2}>
                  MATCHES LIMIT (K)
                </Text>
                <Input
                  type="number"
          ...
          {/* Live Tokenizer compiler terminal */}
          <AnimatePresence>
            {seedText.trim() && (
              <MotionBox
              ...
              >
                <Flex align="center" justify="space-between">
                  <Flex align="center" gap={1.5}>
                    <Box w="8px" h="8px" borderRadius="full" bg={c.red} />
                    <Box w="8px" h="8px" borderRadius="full" bg={c.yellow} />
                    <Box w="8px" h="8px" borderRadius="full" bg={c.green} />
                    <Text
                      fontSize="10px"
                      fontFamily="mono"
                      color={c.overlay1}
        ...
        {/* RIGHT PANEL: Results Workbench (72%) */}
        <Box
          w={{ base: "100%", xl: "72%" }}
          bg={colors.cardBg}
          border={`1px solid ${colors.border}`}
            ...
            {[
              ...
              return (
                <Button
                  ...
                  h="32px"
                  borderRadius="lg"
                  bg={isSelected ? colors.tabSelectedBg : "transparent"}
                ...
                >
                  ...
                  {tab.count !== undefined && (
                    <Text
                      ...
                      px={1.5}
                      py={0.25}
                      bg={isSelected ? colors.cardBg : colors.subBg}
                      border={`1px solid ${colors.border}`}
                      borderRadius="full"
                      fontSize="9px"
                      fontFamily="mono"
          ...
          <Box flex="1">
            ...
            {activeResultsTab === "patterns" && (
              <VStack align="stretch" gap={5}>
                ...
                {result &&
                  (() => {
                    // ── Model the Designer's decision flow ──────────────────
                    // "app_url exists" ≡ the app has prior test cases (specs).
                    // A typed-but-unknown URL has an appId yet no history → it's
                    // a NEW app and skips the in-app step entirely.
                    ...
                    return (
                      <VStack align="stretch" gap={5}>
                        ...
                        {/* Step 2 — cross-app: the fallback (or the whole story
                            for a new app). When reuse fires it's NOT consulted in
                            the real pipeline, so it's collapsed behind a reveal. */}
                        {branch === "reuse" ? (
                          <SkippedCrossApp
                      ...
                      >
                        <HStack gap={2.5} overflow="hidden">
                          <Box
                            color={c.sapphire}
                            p={1.5}
                            bg={catppuccinAlpha(c.sapphire, 0.1)}
                            borderRadius="md"
                          >
                            <FileCode2 size={16} />
                          </Box>
