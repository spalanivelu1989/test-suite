...
export function MigrationDiffView({
  ...
  /** Re-run a subset of failed specs. `heal` = use the Evolver agent. Omitted for
          ...
          >
            ...
            <HStack gap={2}>
              ...
              <Button
                ...
                title="Let the Evolver agent auto-fix selector/state issues using its knowledge, then re-run"
              >
                <Sparkles size={12} />
                Re-run + Evolver
              </Button>
            ...
            <Text fontSize="9.5px" color={hpeSlate} mt={1.5} lineHeight="1.4">
              Straight re-run repeats the tests unchanged. “+ Evolver” first
            ...
            {activeDetailsTab === "source" ? (
              ...
              >
                ...
                >
                  {loadingSourceSpecs ? (
                    ...
                    (() => {
                      const originalSpec =
                        sourceSpecs.find((s) => s.file === selectedSpec.file) ||
                        sourceSpecs.find(
                          (s) =>
              ...
              >
                ...
                <Text
                  ...
                  maxW="360px"
                >
                  This integration test specification completed successfully on
                  the target cloud deployment environment with no regressions.
                </Text>
              </Box>
            )}
          </Flex>
